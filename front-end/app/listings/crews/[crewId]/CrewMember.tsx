...
const CrewMember = ({
  ...
  const [currentSelection, setCurrentSelection] = useState<Employee | null>(
    null
  );
    ...
    if (currentSelection) {
      try {
        ...
        const response = await fetch(
          `https://tasknexus123.azurewebsites.net/api/crews/addEmployees`,
          {
            method: "POST",
            headers: {
            ...
            body: JSON.stringify({
              id: crewId,
              employeeIds: updatedSelectedEmployees.map(
